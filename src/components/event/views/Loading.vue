<template>
    ...
    >
      <h2 class="font-bold text-gray-700">{{ event.title ? event.title : 'Loading...' }}</h2>
      <p class="text-xs text-gray-600">{{ event.location ? event.location.name : 'creating new event!' }}</p>
