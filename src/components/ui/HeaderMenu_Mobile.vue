          ...
          >
            <div class="pb-2 pt-3">
              <div class="flex items-center justify-between px-4">
                ...
                <div class="">
                  <PopoverButton
                    class="inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primaryBlue"
                  >
              ...
              <div class="mt-3 space-y-1 px-2">
                <div
                  ...
                  :key="item.name"
                  @click="goRoute(item.action)"
                  class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-800 cursor-pointer"
